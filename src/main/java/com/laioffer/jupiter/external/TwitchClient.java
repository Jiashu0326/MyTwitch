...
public class
TwitchClient {
    private static final String TOKEN = "Bearer l3w9rfdamqguv1mzfpxodknda5jmkk";
    private static final String CLIENT_ID = "gnf4h0u02uz4sny4lidy5mjeih1qfa";
    ...
    private String searchTwitch(String url) throws TwitchException {
        ...
        ResponseHandler<String> responseHandler = response -> {
            ...
            if (responseCode != 200) {
                ...
                throw new TwitchException("2");
            }
            HttpEntity entity = response.getEntity();
            if (entity == null) {
                throw new TwitchException("3");
            }
    ...
    private List<Game> getGameList(String data) throws TwitchException {
        ObjectMapper mapper = new ObjectMapper();////game本身是java object，这里mapper在jackson里定义的
        try {
            return Arrays.asList(mapper.readValue(data, Game[].class));//这里把jason格式的数据转换成java object的由对象组成的array，后续再转成list。Game[].class是指的运行到这一行时才确定Game这个class长什么样，然后得到对象（java.class method）
    ...
    public List<Game> topGames(int limit) throws TwitchException {
        ...
        return getGameList(searchTwitch(buildGameURL(TOP_GAME_URL, "", limit)));//通过buildgameurl
    }
